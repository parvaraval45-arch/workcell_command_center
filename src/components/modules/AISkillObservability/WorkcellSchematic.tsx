    ...
    <div className="card overflow-hidden flex flex-col">
      ...
      >
        ...
        >
          ...
          <text x="320" y="290" textAnchor="middle" fill="#94A3B8" fontSize="9" fontWeight="500">
            WORK SURFACE
          </text>

          {/* ── Gripper Zone (active area) ────────────────── */}
          <rect x="260" y="130" width="120" height="100" rx="3"
            fill="url(#active-glow)" stroke={activeColor} strokeWidth="0.5" strokeDasharray="3 3" opacity="0.5" />
          <text x="320" y="188" textAnchor="middle" fill={activeColor} fontSize="8" opacity="0.6">
            ACTIVE ZONE
          </text>
          ...
          <g transform={`translate(320, 180)`}>
            {/* Base circle */}
            <circle cx="0" cy="0" r="18" fill="none" stroke="#94A3B8" strokeWidth="1.5" />
            <circle cx="0" cy="0" r="6" fill="#E2E8F0" stroke="#94A3B8" strokeWidth="1" />
            ...
            <g style={{ transform: `rotate(${armAngle}deg)`, transformOrigin: '0 0', transition: 'transform 1s ease-in-out' }}>
              {/* Lower arm */}
              <line x1="0" y1="0" x2="-35" y2="-55" stroke="#64748B" strokeWidth="3" strokeLinecap="round" />
              <circle cx="-35" cy="-55" r="4" fill="#F1F5F9" stroke="#64748B" strokeWidth="1" />

              {/* Upper arm */}
              <line x1="-35" y1="-55" x2="10" y2="-95" stroke="#64748B" strokeWidth="2.5" strokeLinecap="round" />
              <circle cx="10" cy="-95" r="3.5" fill="#F1F5F9" stroke="#64748B" strokeWidth="1" />

              {/* End effector / gripper */}
              <line x1="10" y1="-95" x2="3" y2="-110" stroke="#64748B" strokeWidth="1.5" strokeLinecap="round" />
              <line x1="10" y1="-95" x2="17" y2="-110" stroke="#64748B" strokeWidth="1.5" strokeLinecap="round" />
            </g>

            {/* Label */}
            <text x="0" y="32" textAnchor="middle" fill="#64748B" fontSize="8" fontWeight="600">
              UR5e
            </text>
          ...
          <text x="95" y="145" textAnchor="middle" fill="#64748B" fontSize="8" fontWeight="500">
            TRAY A
          </text>
          <text x="95" y="157" textAnchor="middle" fill="#94A3B8" fontSize="7">
            Input Parts
          </text>
          ...
          <rect x="500" y="110" width="90" height="60" rx="3"
            fill="none" stroke="#94A3B8" strokeWidth="1" />
          <text x="545" y="145" textAnchor="middle" fill="#64748B" fontSize="8" fontWeight="500">
            TRAY B
          </text>
          <text x="545" y="157" textAnchor="middle" fill="#94A3B8" fontSize="7">
            Output
          </text>
          ...
          <g transform="translate(170, 40)">
            ...
            <text x="0" y="-12" textAnchor="middle" fill="#94A3B8" fontSize="7" fontWeight="600">
              Basler CAM-01
            </text>
          ...
          <g transform="translate(320, 250)">
            ...
            <text x="0" y="3" textAnchor="middle" fill="#94A3B8" fontSize="7">
              F/T Sensor
            </text>
          ...
          <g transform="translate(30, 320)">
            ...
            <text x="8" y="3" fill="#94A3B8" fontSize="7">Healthy</text>
            <circle cx="55" cy="0" r="3" fill="var(--status-degraded)" opacity="0.8" />
            <text x="63" y="3" fill="#94A3B8" fontSize="7">Degraded</text>
            <circle cx="120" cy="0" r="3" fill="var(--status-critical)" opacity="0.8" />
            <text x="128" y="3" fill="#94A3B8" fontSize="7">Fault</text>
          </g>

          {/* Scale reference */}
          <g transform="translate(30, 345)">
            <line x1="0" y1="0" x2="64" y2="0" stroke="#94A3B8" strokeWidth="0.5" />
            <line x1="0" y1="-3" x2="0" y2="3" stroke="#94A3B8" strokeWidth="0.5" />
            <line x1="64" y1="-3" x2="64" y2="3" stroke="#94A3B8" strokeWidth="0.5" />
            <text x="32" y="-5" textAnchor="middle" fill="#94A3B8" fontSize="7">1 m</text>
          </g>
        </svg>
      </div>
    </div>
